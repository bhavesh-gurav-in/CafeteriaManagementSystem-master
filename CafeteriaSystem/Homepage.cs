...
namespace CafeteriaSystem
{
    public partial class Dashboard : Form
    {
        ...
        private void UserNameIDMenuLabel_Click(object sender, EventArgs e)
        {

        }

        private void CategoriesFlowPanel_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void BillGroupBox_Enter(object sender, EventArgs e)
        {
